            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
             ...
             transition-all duration-300"
                    ...
                    <div className="w-full text-gray-800 dark:text-white">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8" data-aos-delay="600" data-aos="fade-down">
                            <div className="flex flex-col gap-2">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <h3 className="text-xl font-bold text-gray-800 dark:text-white">Who Am</h3>
                                </div>
                            ...
                            <div className="flex flex-col gap-2">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <h3 className="text-xl font-bold text-gray-800 dark:text-white">My Focus</h3>
                                </div>
                                <p className="text-gray-700 dark:text-gray-300">
                        ...
                        <Tippy content="Unduh Rangkuman Ku">
                            <button
                                onClick={() => {
                                    Swal.fire({
                                        title: "Belum Tersedia😅",
                                        text: "Mungkin Nanti hehe",
                                        icon: "info",
                                        confirmButtonColor: "#1F2937", 
                                        confirmButtonText: "Wokey",
                                    });
                                }}
                                className={resumeButtonClasses}
                                aria-label="Unduh Rangkuman"
                                data-aos-delay="600"
                                data-aos="fade-down"
                            >
